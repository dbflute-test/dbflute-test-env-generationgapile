...
public abstract class BsUnpaidSummaryMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dbflute.bsentity.customize.dbmeta.UnpaidSummaryMemberDbm.getInstance();
    }
    ...
    /**
     * [get] (会員名称)UNPAID_MAN_NAME: {VARCHAR(100), refers to member.MEMBER_NAME} <br>
     * 会員のフルネームの名称。<br>
    ...
    /**
     * [set] (会員名称)UNPAID_MAN_NAME: {VARCHAR(100), refers to member.MEMBER_NAME} <br>
     * 会員のフルネームの名称。<br>
     * 苗字と名前を分けて管理することが多いが、ここでは単純にひとまとめ。
