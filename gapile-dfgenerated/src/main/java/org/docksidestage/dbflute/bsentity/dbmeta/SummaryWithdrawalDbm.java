...
public class SummaryWithdrawalDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "メンバーID", Integer.class, "memberId", null, false, false, true, "INT", 10, 0, null, false, null, null, null, null, null, false);
    ...
    /**
     * (メンバーID)MEMBER_ID: {NotNull, INT(10)}
