...
public class UnpaidSummaryMemberDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnUnpaidManId = cci("UNPAID_MAN_ID", "UNPAID_MAN_ID", null, "会員ID", Integer.class, "unpaidManId", null, true, false, false, "INT", 11, 0, null, false, null, null, null, null, null, false);
    protected final ColumnInfo _columnUnpaidManName = cci("UNPAID_MAN_NAME", "UNPAID_MAN_NAME", null, "会員名称", String.class, "unpaidManName", null, false, false, false, "VARCHAR", 100, 0, null, false, null, null, null, null, null, false);
    ...
    /**
     * (会員名称)UNPAID_MAN_NAME: {VARCHAR(100), refers to member.MEMBER_NAME}
     * @return The information object of specified column. (NotNull)
     */
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.dbflute.exentity.customize.UnpaidSummaryMember"; }
