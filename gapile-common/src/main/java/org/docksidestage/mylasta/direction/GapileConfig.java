...
import org.docksidestage.mylasta.direction.GapileEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface GapileConfig extends GapileEnv {

    /** The key of the configuration. e.g. gapile */
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends GapileEnv.SimpleImpl implements GapileConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(GapileConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(GapileConfig.DOMAIN_TITLE);
        }

        public String getCookieDefaultPath() {
            return get(GapileConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(GapileConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(GapileConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(GapileConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(GapileConfig.COOKIE_ETERNAL_EXPIRE);
        }
    }
}
