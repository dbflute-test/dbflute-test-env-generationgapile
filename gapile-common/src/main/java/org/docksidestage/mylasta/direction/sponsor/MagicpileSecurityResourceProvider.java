 ...
 * @author jflute
 */
public class MagicpileSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public MagicpileSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
