 ...
 * @author jflute
 */
public class MagicpileMailDeliveryDepartmentCreator {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final MagicpileConfig magicpileConfig;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public MagicpileMailDeliveryDepartmentCreator(MagicpileConfig magicpileConfig) {
        this.magicpileConfig = magicpileConfig;
    }
    ...
    protected SMailPostalParkingLot createPostalParkingLot() {
        ...
        final String hostAndPort = magicpileConfig.getMailSmtpServerMainHostAndPort();
        ...
        motorbike.registerReturnPath(magicpileConfig.getMailReturnPath());
    ...
    protected SMailPostalPersonnel createPostalPersonnel() {
        ...
        return magicpileConfig.isMailSendMock() ? personnel.asTraining() : personnel;
    }

    protected SMailDogmaticPostalPersonnel newMailDogmaticPostalPersonnel() { // #ext_point e.g. from database
        final String testPrefix = magicpileConfig.getMailSubjectTestPrefix();
