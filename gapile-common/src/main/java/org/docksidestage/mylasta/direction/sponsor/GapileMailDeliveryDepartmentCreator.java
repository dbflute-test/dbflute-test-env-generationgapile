 ...
 * @author jflute
 */
public class GapileMailDeliveryDepartmentCreator {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final GapileConfig gapileConfig;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public GapileMailDeliveryDepartmentCreator(GapileConfig gapileConfig) {
        this.gapileConfig = gapileConfig;
    }
    ...
    protected SMailPostalParkingLot createPostalParkingLot() {
        ...
        final String hostAndPort = gapileConfig.getMailSmtpServerMainHostAndPort();
        ...
        motorbike.registerReturnPath(gapileConfig.getMailReturnPath());
    ...
    protected SMailPostalPersonnel createPostalPersonnel() {
        ...
        return gapileConfig.isMailSendMock() ? personnel.asTraining() : personnel;
    }

    protected SMailDogmaticPostalPersonnel newMailDogmaticPostalPersonnel() { // #ext_point e.g. from database
        final String testPrefix = gapileConfig.getMailSubjectTestPrefix();
