 ...
 * @author jflute
 */
public class MagicpileCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = MagicpileUserTimeZoneProcessProvider.centralTimeZone;
