 ...
 * @author jflute
 */
public class GapileSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public GapileSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
