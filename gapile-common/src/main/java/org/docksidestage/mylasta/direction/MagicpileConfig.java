...
import org.docksidestage.mylasta.direction.MagicpileEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface MagicpileConfig extends MagicpileEnv {

    /** The key of the configuration. e.g. magicpile */
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends MagicpileEnv.SimpleImpl implements MagicpileConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(MagicpileConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(MagicpileConfig.DOMAIN_TITLE);
        }

        public String getCookieDefaultPath() {
            return get(MagicpileConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(MagicpileConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(MagicpileConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(MagicpileConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(MagicpileConfig.COOKIE_ETERNAL_EXPIRE);
        }
    }
}
