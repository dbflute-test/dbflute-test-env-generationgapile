 ...
 * @author jflute
 */
public abstract class MagicpileBaseAction extends TypicalAction {
    ...
    //                                                                           =========
    @Override
    protected abstract OptionalThing<? extends MagicpileUserBean> getUserBean(); // to be more concrete
