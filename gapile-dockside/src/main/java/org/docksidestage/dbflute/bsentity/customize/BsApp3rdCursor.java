 ...
 */
public abstract class BsApp3rdCursor extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dbflute.bsentity.customize.dbmeta.App3rdCursorDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsApp3rdCursor) {
            BsApp3rdCursor other = (BsApp3rdCursor)obj;
    ...
    @Override
    public App3rdCursor clone() {
        return (App3rdCursor)super.clone();
    }
