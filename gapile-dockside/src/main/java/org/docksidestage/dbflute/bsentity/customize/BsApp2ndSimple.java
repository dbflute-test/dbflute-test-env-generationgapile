 ...
 */
public abstract class BsApp2ndSimple extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dbflute.bsentity.customize.dbmeta.App2ndSimpleDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsApp2ndSimple) {
            BsApp2ndSimple other = (BsApp2ndSimple)obj;
    ...
    @Override
    public App2ndSimple clone() {
        return (App2ndSimple)super.clone();
    }
