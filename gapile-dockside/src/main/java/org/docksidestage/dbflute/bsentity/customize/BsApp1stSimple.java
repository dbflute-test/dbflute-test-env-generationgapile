 ...
 */
public abstract class BsApp1stSimple extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.dbflute.bsentity.customize.dbmeta.App1stSimpleDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsApp1stSimple) {
            BsApp1stSimple other = (BsApp1stSimple)obj;
    ...
    @Override
    public App1stSimple clone() {
        return (App1stSimple)super.clone();
    }
